...
The attacker performed repeated failed login attempts against SSH services. A high volume of authentication failures (10800 attempts) was observed from a single source IP, consistent with automated brute force behaviour.
